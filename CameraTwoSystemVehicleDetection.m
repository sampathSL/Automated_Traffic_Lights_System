function [Status,Exception,cacledMinObjY,numberOfVehicles] = CameraTwoSystemVehicleDetection(numberOfFrames,threshold,unwantedBlobSize,trackMinBlobSize,backgroundImage,laneMarginData,isVehicleDrivingLeftSide)
    ...
    try
        ...
        roadWithoutVehiclesDouble(:,:,2) = roadWithoutVehiclesDouble(:,:,3)./misc;
         ...
         currentFrames = vidObjectTwo.FramesAcquired;
        ...
        while(vidObjectTwo.FramesAcquired <= ( currentFrames + numberOfFrames))

            % Get the snapshot of the current frame
            currentImage = getsnapshot(vidObjectTwo);
            ...
            %image show;
            subplot(2,2,2),imshow(currentImage);
            hold on
            pause(0.001);
